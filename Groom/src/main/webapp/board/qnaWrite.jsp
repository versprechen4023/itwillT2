		...
		<div class="fh5co-narrow-content">
			...
			<form action="qnawritePro.bo" method="post" class="qnawrite">
				...
				<div class="abc">
					...
					<div>
						<p class="p">글 제목</p>
						<input type="text" class="qna_title" placeholder="제목을 입력해주세요." name="qna_title">
					</div>

					<div>
						<p>글 내용</p>
						<textarea cols="108" rows="10" placeholder="Input some text." name ="qna_content"></textarea>
					</div>

					<div>
					<p> 첨부 파일 </p>
						<input type="text" class="qnaimage" placeholder="사진을 첨부해주세요" name="qna_img_url">
					</div>
				...
				<div class="qna-buttons">
					<input type="submit" value="확인" class="내용을 입력해주세요.">
