...
<!-- css추가  -->
	<link rel="stylesheet" href="./css/qnaUpdate_gr.css">
...
<body>
	...
	<div id="fh5co-main">
		...
		<div class="fh5co-narrow-content">
			<h2 class="h2">Q&A 수정 </h2>

			<form action="qnaUpdatePro.bo" method="post" class="qnawrite" enctype="multipart/form-data">
				...
				<div class="abc">
					...
					<input type="hidden" name="qna_num" value="<%=qnaDTO.getQnanum() %>">
