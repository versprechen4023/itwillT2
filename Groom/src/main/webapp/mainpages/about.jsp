			...
			<div class="fh5co-narrow-content">
				...
				<div class="row">
					<div class="col-md-6 col-md-offset-3 col-md-pull-3 animate-box" data-animate-effect="fadeInLeft">
						...
						<p class="btn btn-primary" id="call_api" onclick="callAPI()">아임포트 결제API 호출</p>
						<p class="btn btn-primary" id="call_api_naver" onclick="callAPINaver()">네이버 결제API 호출</p>
...
<script>
let val = 10 //여기서 일단 가격 조정 추후에 DB에서 가져와야함?
let name = "아이티윌팀프로젝트 2팀" // 서비스나 물건이름 여기서일단 설정
